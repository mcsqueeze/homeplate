...
m3 = Meal.create(title: "Msimmon", user: User.first, description: "Savory, fried, traditional bread", maxservings: 25, category: "side", price: 6)
p3 = Picture.new
p3.meal = m3
...
m4 = Meal.create(title: "Harsha", user: User.first, description: "Buttery cornbread great with honey & cheese", maxservings: 20, category: "side", price: 4)
p4 = Picture.new
p4.meal = m4
...
m5 = Meal.create(title: "Beef & Prune Tajine", user: User.first, description: "Stewed and tender beef with plump prunes in a savoury sauce", maxservings: 10, category: "main course", price: 35)
p5 = Picture.new
p5.meal = m5
...
m6 = Meal.create(title: "Lemon Chicken Tagine", user: User.first, description: "Marinated chicken with preserved lemon for a tangy citrus kick", maxservings: 15, category: "main course", price: 40)
p6 = Picture.new
p6.meal = m6
