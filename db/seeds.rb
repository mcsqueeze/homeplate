...
m1 = Meal.new(title: "CousCous", user: User.first, description: "Delicious, Savory Chicken Couscous with Tfaya", price: "50.00")
...
u1 = User.create(email: "margaux@gmail.com", password: "margaux", usertype: "cook")
m2 = Meal.new(title: "Rfissa", user: User.first, description: "Scrumptous Chicken with Msimmon and Helba", price: "45.00")
...
u1 = User.create(email: "margaux@gmail.com", password: "margaux", usertype: "cook")
m3 = Meal.new(title: "Msimmon", user: User.first, description: "Savory, fried, traditional bread", price: "50.00")
...
u1 = User.create(email: "margaux@gmail.com", password: "margaux", usertype: "cook")
m4 = Meal.new(title: "Harsha", user: User.first, description: "Buttery cornbread great with honey & cheese", price: "50.00")
...
u1 = User.create(email: "margaux@gmail.com", password: "margaux", usertype: "cook")
m5 = Meal.new(title: "Beef & Prune Tajine", user: User.first, description: "Stewed and tender beef with plump prunes in a savoury sauce", price: "50.00")
...
u1 = User.create(email: "margaux@gmail.com", password: "margaux", usertype: "cook")
m6 = Meal.new(title: "Lemon Chicken Tagine", user: User.first, description: "Marinated chicken with preserved lemon for a tangy citrus kick", price: "50.00")
