...
u1 = User.new(email: "maria@gmail.com", first_name: "Maria", username: "ChefMaria", password: "123456", usertype: "cook", phonenumber: "06 78 54 76 43", address: "42 Boulevard de la Résistance, Casablanca")
...
u4 = User.new(email: "rachida@gmail.com", username: "Rachida", password: "123456", usertype: "cook", phonenumber: "06 78 54 76 43", address: "76 Boulevard d’Anfa, Casablanca")
...
u6 = User.new(email: "mounia@gmail.com", username: "Mounia", password: "123456", usertype: "cook", phonenumber: "06 78 54 76 43", address: "270 Boulevard Mohamed Zerktouni, Casablanca")
u6.remote_photo_url = "https://res.cloudinary.com/homeplate/image/upload/v1544777755/zfkNiosF.jpg"
u6.save!

u7 = User.new(email: "anna@gmail.com", username: "missanna", password: "123456", usertype: "customer", phonenumber: "06 78 54 76 43")
u7.remote_photo_url = "https://res.cloudinary.com/homeplate/image/upload/v1544784872/fuchtman_photo.jpg"
u7.save!

u8 = User.new(email: "fadwa@gmail.com", username: "Fadwa", password: "123456", usertype: "customer", phonenumber: "06 78 54 76 43")
u8.remote_photo_url = "https://res.cloudinary.com/homeplate/image/upload/v1544778113/asa-hutchinson.jpg"
u8.save!


u9 = User.new(email: "abdel@gmail.com", username: "Abdel", password: "123456", usertype: "customer", phonenumber: "06 78 54 76 43")
